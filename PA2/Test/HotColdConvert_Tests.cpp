...
extern bool HotColdConvert_Test;

TEST_WITH_TEARDOWN(Convert_HotCold, TestConfig::ALL)
{
	...
	CHECK(pFoundHotNode->key == 0x1f825b7b);
	...
	CHECK(pFoundHotNode->key == 0x5afd40d8);
	CHECK(pFoundHotNode->pCold == pFoundColdNode);
	...
	CHECK(pFoundHotNode->key == 0x1ddb17bc);
	CHECK(pFoundHotNode->pCold == pFoundColdNode);
	...
	CHECK(pFoundHotNode->key == 0x6e997539);
	CHECK(pFoundHotNode->pCold == pFoundColdNode);
	...
	HotColdConvert_Test = true;

} TEST_END

TEST_TEARDOWN(Convert_HotCold)
{
	delete pHotCold;
}
