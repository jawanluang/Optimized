...
private:
	...
	void addSecretPtr(Free* pFree);
	Free* CoalesceTop(Free* top, Free* pFree);
	Free* CoalesceBottom(Free* pFree, Free* bottom);
	Free* CoalesceSandwhich(Free* top, Free* pFree, Free* bottom);
